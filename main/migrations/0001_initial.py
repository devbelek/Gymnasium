    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('surname', models.CharField(max_length=25, verbose_name='Фамилия')),
                ('last_name', models.CharField(max_length=25, verbose_name='Отчество')),
                ('administrator_status', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='secondary.administratortypes', verbose_name='Позиция')),
                ('olympian_status', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='secondary.namesofolympia', verbose_name='Олимпиец')),
                ('olympian_status_ky', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='secondary.namesofolympia', verbose_name='Олимпиец')),
                ('olympian_status_ru', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='secondary.namesofolympia', verbose_name='Олимпиец')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name_of_grade', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='secondary.nameofgrades', verbose_name='Класс')),
                ('student', models.OneToOneField(blank=True, on_delete=django.db.models.deletion.CASCADE, to='main.students', verbose_name='Ученик')),
            ],
            options={
